...
class PagedAttention(nn.Module):
    ...
    def __init__(self,
        ...
        self.ds_attn_kernel = BlockedFlashAttn(self.head_size, dtype)
    ...
    def single_query_cached_kv_attention(
        ...
        # # TODO(): Unnecessary copy. Optimize.
        single_query_tokens = input_metadata.tokens_use_single_query_kernel
        attention_ops.single_query_cached_kv_attention(
            ...
            self.head_mapping,
            self.scale,
            input_metadata.block_tables[:single_query_tokens],
            input_metadata.context_lens[:single_query_tokens],
            block_size,
    ...
    def forward(
        ...
        Args:
            ...
            value_cache: shape = [num_blocks, block_size, num_heads, head_size]
            input_metadata: metadata for paged attention.
        ...
        if cache_event is not None:
            ...
            global CACHE_EVENTS
            CACHE_EVENTS.append((start, end, input_metadata.num_valid_tokens, sin, sout))
        ...
        if (num_valid_tokens > 0 and key_cache is not None
            ...
            # print(key_to_cache.shape, value_to_cache.shape, slot_mapping.shape, key_cache.shape, value_cache.shape)
            cache_ops.new_reshape_and_cache(
                key_to_cache,
                value_to_cache,
                key_cache,
                value_cache,
        ...
        if input_metadata.num_generation_tokens > 0:
            ...
            self.ds_attn_kernel(output[num_prompt_tokens:num_valid_tokens].view(-1, self.num_heads * self.head_size),
                                query[num_prompt_tokens:num_valid_tokens].view(-1, self.num_heads * self.head_size),
                                key_cache,
                                value_cache,
                                input_metadata.atoms,
                                self.scale
                                )
